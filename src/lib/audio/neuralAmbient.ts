...
const BEDS: Record<AudioBedId, BedConfig> = {
  ...
  /** Synthesized crystal-bowl field — no sample assets. */
  crystal: {
    carrierHz: 256,
    beatHz: 3.2,
    band: "theta-crystal",
    intent: "crystal bowl field",
    padGain: 0.7,
    binauralGain: 0.28,
    droneHz: [64, 128, 192, 256, 384],
    noiseLp: 280,
    noiseGain: 0.08,
    lfoHz: 0.03,
    lfoDepth: 0.05,
  },
  /** Soft filtered breath / forest canopy hiss. */
  forest: {
    carrierHz: 174,
    beatHz: 5.5,
    band: "theta-forest",
    intent: "forest breath",
    padGain: 0.48,
    binauralGain: 0.32,
    droneHz: [43.5, 87, 130.5],
    noiseLp: 720,
    noiseGain: 0.22,
    lfoHz: 0.09,
    lfoDepth: 0.06,
  ...
  deepheal: {
    ...
    padGain: 0.72,
    binauralGain: 0.3,
    droneHz: [36, 54, 72, 108],
    noiseLp: 260,
    noiseGain: 0.1,
    lfoHz: 0.025,
    lfoDepth: 0.03,
  },
  /** Soft golden pulse bed. */
  golden: {
    carrierHz: 196,
    beatHz: 6,
    band: "alpha-gold",
